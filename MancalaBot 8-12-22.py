...
##TO-DO
# Look at next player's moves (add depth)
# Maybe store pre-calculated boards in a text file to save computing time?
...
def Main():
    ...
    bestscore = sortedresults[0][0]

    print("\nBest moves give", bestscore, "score:")
